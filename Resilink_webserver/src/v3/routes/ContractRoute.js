 ...
 * /v3/contracts:
 *   post: 
 *     summary: Create a new contract (from ODEP)
 *     tags: [Contracts]
 *     requestBody:
 *       description: The offerId, requestId and receivingAssetID to create the contract and execute the pre-payment
 *       required: true
 *       content:
 *         application/json:
 *           schema:
...
/**
 * @swagger
 * /v3/contracts/measurableByQuantityContract/{id}:
 *   patch: 
...
/**
 * @swagger
 * /v3/contracts/measurableByTimeContract/{id}:
 *   patch: 
