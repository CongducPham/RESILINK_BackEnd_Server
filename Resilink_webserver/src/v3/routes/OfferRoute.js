...
/**
 * @swagger
 * /v3/offers/owner/blockedOffer/{id}:
 *   get:
...
/**
 * @swagger
 * /v3/offers/all/resilink/filtered:
 *   post: 
...
router.get('/offers/owner/', offerController.getAllOwnerOffer);

/**
 * @swagger
 * /v3/offers/owner/purchase:
 *   get:
 ...
 *   post: 
 *     summary: Create a new offer and its asset
 *     tags: [Offer]
 *     requestBody:
 *       required: true
 *       content:
