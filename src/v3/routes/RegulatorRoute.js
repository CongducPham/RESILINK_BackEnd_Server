 ...
 *                       type: string
 */
router.post('/ODEP/regulators', auth({ required: true }), regulatorController.createRegulator);

/**
 * @swagger
 * /v3/ODEP/regulators/all:
 *   get:
 ...
 *                       type: string
 */
router.get('/ODEP/regulators/all', auth({ required: true }), regulatorController.getAllRegulator);

/**
 * @swagger
 * /v3/ODEP/regulators/{id}:
 *   get:
 ...
 *                       type: string
 */
router.get('/ODEP/regulators/:id', auth({ required: true }), regulatorController.getOneRegulator);
 ...
 *                       type: string
 */
router.patch('/ODEP/regulators/:id', auth({ required: true }), regulatorController.patchOneRegulator);
 ...
 *                       type: string
 */
router.delete('/ODEP/regulators/:id', auth({ required: true }), regulatorController.deleteRegulator);
